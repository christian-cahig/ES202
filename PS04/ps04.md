...
$-1,0,1$.
Hence, homogeneous solution is a superposition of basis functions
$e^{-x}$, $e^{0x}$, and $e^{x}$:
...
The particular solution is then a superposition of basis functions
$x e^{-x}$ and $e^{2x}$:
...
Hence, the general solution to (1.0)
